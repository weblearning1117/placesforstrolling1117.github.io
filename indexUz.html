...
<head>
  ...
  <link rel="stylesheet" href="css/styleUz.css">
  <link href="https://fonts.googleapis.com/css?family=Comfortaa:300,400,700" rel="stylesheet"> 
</head>

<body>
  <div class="warning"><p>Iltimos, barcha savollarga javob bering <span class="exclamation">!</span></p> </div>
  ...
  <div class="container section-1">
    <div class="row">
      <div class="col-lg-12 question">
        <h2>Kimlar bilan vaqtingizni õtkazmoqchisiz?</h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12 question">
        <h2>Nech kishi bõlib sayirga chiqmoqchisiz?</h2>
      </div>
    </div>
    ...
    <div class="row ">
      <div class="col-lg-12 question">
        <h2>Kunning qaysi paytida sayirga chiqmoqchisiz?</h2>
      </div>
    </div>
    ...
    <div class="row justify-content-center question1 click" data-i ="1" data-many="4">
      ...
      <div class="col-lg-2 col-3 answer answer4" data-age="39+"  data-order="4">
        <p> <span class="margin-right"> 39+ <br></span> yosh</p>
      </div>
      <div class="back back1"> <i class="fa fa-undo" aria-hidden="true"></i>
      </div>
    </div>
    <p class="next active disabled first"><span class="txt">Oldinga </span>  <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
    </p>
  ...
  <div class="container section-2 active">
    <div class="row">
      <div class="col-lg-12 question">
        <h2>Vaqtingizni qanday õtkazmoqchisiz?</h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12 question">
        <h2>Qaysi tumanga bormoqchisiz?</h2>
      </div>
    </div>
    ...
    <div class="row justify-content-center question6 question8 click"  data-many="3" data-row= "3">
      <div class="col-lg-2 col-3 answer answer7" data-order="1"><p class="reltop relright">Shayhantahur </p> </div>
      <div class="col-lg-2 col-3 answer answer8" data-order="2"><p class="reltop">Yunusabad</p>
...
<p class="main-back"><span class="main-back-text">Orqaga</span><i class="fa fa-undo" aria-hidden="true"></i>
  </p>
